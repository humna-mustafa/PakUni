...
export const SCHOLARSHIPS: ScholarshipData[] = [
  // ========== GOVERNMENT SCHOLARSHIPS ==========
  {
    ...
    application_deadline: 'Check website (usually Nov-Dec)',
    website: 'https://hec.gov.pk/english/scholarshipsgrants/ehsaas/',
    min_percentage: 50,
  ...
  },
  {
    ...
    application_deadline: 'Check website (usually Aug-Oct)',
