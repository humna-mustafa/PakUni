...
export const ENTRY_TESTS_DATA: EntryTestData[] = [
  {
    ...
    application_steps: [
      ...
      'Generate Fee Challan Rs. 9000 (Late fee Rs. 13000) and pay at HBL/ABL',
      'International exam fee different - check PMC portal',
  ...
  },
  {
    ...
    description: 'Entrance test for NUST undergraduate programs. 4 series: NET-1 (Oct-Nov), NET-2 (Dec-Feb), NET-3 (Feb-Apr), NET-4 (Apr-Jun). Best score counts!',
    ...
    tips: [
      'Take multiple series - best score counts for final merit!',
      'Time management is key - 200 questions in 180 minutes',
      'No negative marking, so attempt all questions',
      'CBNET centers: Islamabad, Quetta | PBNET centers: Karachi, Gilgit',
      'Series-1: Oct-Nov | Series-2: Dec-Feb | Series-3: Feb-Apr | Series-4: Apr-Jun',
    ],
    provinces: ['all-pakistan'],
    application_steps: [
      'Register on NUST Undergraduate Admissions Portal',
      'Fill in personal and academic details',
      'Upload recent photograph (JPEG, max 200KB)',
      'Generate and pay challan in HBL',
      'Select your test series and center (CBNET or PBNET)',
      'Take multiple series for better chances - best score counts!',
    ],
    status_notes: 'Series-2 Test: Jan 31 - Feb 2, 2026 | Series-3: Feb-Apr | Series-4: Apr-Jun | Take multiple for best score!',
  ...
  },
  {
    ...
    description: 'Provincial entrance test for admission to engineering programs in Punjab universities including UET Lahore, UET Taxila, and affiliated colleges. Fall 2026 registration opens soon.',
    ...
    tips: [
      ...
      'Test Duration: Mar 30 - Apr 3, 2026 (multiple slots)',
      'Admit Card available from Mar 24, 2026',
    ],
    provinces: ['Punjab'],
    status_notes: 'Fall 2026: Deadline Mar 22 | Test Mar 30-Apr 3 | Result Apr 17 | Fee Rs. 3000',
    application_steps: [
      ...
      'Select Test Center and Date slot (Mar 30 - Apr 3)',
      'Download Admit Card from Mar 24, 2026',
      'Register separately for Hafiz test if applicable (20 marks bonus)',
    ],
  ...
  {
    id: 'nca-test-2026',
    name: 'NCA Aptitude Test',
    full_name: 'National College of Arts Aptitude Test',
    conducting_body: 'National College of Arts',
    description: 'Specialized aptitude test for admission to NCA\'s BFA and BDes programs. Tests drawing skills, creativity, and artistic ability.',
    applicable_for: ['Fine Arts', 'Design', 'Architecture', 'Film & TV', 'Miniature Painting'],
    ...
    test_format: {
      ...
      negative_marking: false,
      sections: [
        {name: 'Still Life Drawing', questions: 1, marks: 50},
        {name: 'Composition', questions: 1, marks: 50},
        {name: 'Color Application', questions: 1, marks: 40},
        {name: 'Creative Problem Solving', questions: 1, marks: 30},
        {name: 'Portfolio Review', questions: 1, marks: 30},
      ],
    },
    tips: [
      'Practice observational drawing daily',
      'Build a diverse portfolio (minimum 10 works)',
      'Study color theory and composition principles',
      'Visit NCA website for sample test papers',
      'Bring your own drawing/painting materials',
    ],
    provinces: ['All Pakistan'],
    status_notes: 'Registration Expected April 2026',
  },
  {
    id: 'bnu-test-2026',
    name: 'BNU Admission Test',
    full_name: 'Beaconhouse National University Admission Test',
    conducting_body: 'Beaconhouse National University',
    description: 'Admission test for BNU undergraduate programs including liberal arts, sciences, design, and media studies.',
    applicable_for: ['Social Sciences', 'Design', 'Media Studies', 'Computer Science', 'Business'],
    registration_start: '2026-03-01',
    registration_deadline: '2026-06-30',
    test_date: '2026-07-10',
    result_date: '2026-07-25',
    website: 'https://www.bnu.edu.pk/admissions/',
    fee: 3000,
    eligibility: [
      'FA/FSc/A-Level with 50%+ marks',
      'Design programs require portfolio',
    ...
    test_format: {
      ...
      negative_marking: false,
      sections: [
        {name: 'English Comprehension', questions: 25, marks: 25},
        {name: 'Analytical Reasoning', questions: 25, marks: 25},
        {name: 'General Knowledge', questions: 15, marks: 25},
        {name: 'Subject-specific', questions: 15, marks: 25},
      ],
    },
    tips: [
      'Focus on English comprehension and vocabulary',
      'Practice analytical reasoning questions',
      'Prepare portfolio well in advance for design programs',
      'Read current affairs for general knowledge section',
    ],
    provinces: ['All Pakistan'],
    status_notes: 'Early admission round starts March 2026',
  },
  {
    id: 'air-uni-test-2026',
    name: 'Air University Test',
    full_name: 'Air University Admission Test',
    conducting_body: 'Air University Islamabad',
    description: 'Entrance test for BS Engineering, CS, and management programs at Air University.',
    applicable_for: ['Engineering', 'Computer Science', 'Avionics', 'Mechatronics', 'Business'],
    registration_start: '2026-05-01',
    registration_deadline: '2026-07-15',
    test_date: '2026-08-01',
    result_date: '2026-08-15',
    website: 'https://www.au.edu.pk/admissions/',
    fee: 2500,
    eligibility: [
      'FSc Pre-Engineering with 60%+ marks',
      'A-Level equivalent with relevant subjects',
      'PAF dependents get preference',
    ],
    test_format: {
      total_marks: 100,
      total_questions: 100,
      ...
      sections: [
        ...
        {name: 'Physics', questions: 25, marks: 25},
        {name: 'English', questions: 20, marks: 20},
        {name: 'IQ/General', questions: 15, marks: 15},
      ],
    },
    tips: [
      'Strong mathematics is key for Air University',
      'Focus on FSc Pre-Engineering syllabus',
      'Air University offers defense-related programs',
      'Multiple test dates available - choose wisely',
    ],
    provinces: ['All Pakistan'],
    status_notes: 'Multiple test sessions May-August 2026',
  },
  {
    id: 'ist-test-2026',
    name: 'IST Entry Test',
    full_name: 'Institute of Space Technology Entry Test',
    conducting_body: 'Institute of Space Technology',
    description: 'Competitive entry test for BS and MS programs at IST including Aerospace Engineering.',
    applicable_for: ['Aerospace Engineering', 'Electrical Engineering', 'Mechanical Engineering', 'Computer Science', 'Materials Engineering'],
    registration_start: '2026-05-01',
    registration_deadline: '2026-06-30',
    ...
    fee: 3000,
    eligibility: [
      'FSc Pre-Engineering with 70%+ marks',
      'A-Level with Physics, Math, Chemistry',
      'High merit - competitive admission',
    ],
    test_format: {
      total_marks: 100,
      total_questions: 100,
    ...
    tips: [
      'Strong physics and math foundation required',
      'Study rocket science and space technology basics',
      'IST is associated with SUPARCO',
      'Limited seats - prepare thoroughly',
    ],
    provinces: ['All Pakistan'],
  ...
  {
    id: 'aku-test-2026',
    name: 'AKU Admission Test',
    full_name: 'Aga Khan University Admission Test',
    conducting_body: 'Aga Khan University',
    description: 'Comprehensive admission test for AKU medical (MBBS), nursing (BScN), and other health science programs in Karachi.',
    applicable_for: ['MBBS', 'BScN', 'Nursing', 'Medical Sciences'],
    ...
    fee: 5000,
    eligibility: [
      'FSc Pre-Medical or A-Level Biology with 80%+ marks',
      'SAT Subject Tests accepted',
      'Strong extracurricular profile recommended',
    ],
    test_format: {
      total_marks: 200,
      total_questions: 150,
      ...
      negative_marking: true,
      sections: [
        {name: 'Biology', questions: 50, marks: 60},
        {name: 'Chemistry', questions: 35, marks: 45},
        {name: 'Physics/Math', questions: 30, marks: 40},
        {name: 'English & Reasoning', questions: 35, marks: 55},
      ],
    },
    tips: [
      'AKU test is one of the toughest in Pakistan',
      'Practice SAT-style reasoning questions',
      'Interview carries 20% weightage - prepare',
      'Strong English comprehension needed',
      'Focus on application-based questions',
    ],
    provinces: ['All Pakistan'],
    status_notes: 'Early registration Sep 2025, Test Jan 2026',
  },
  {
    id: 'sindh-uet-2026',
    name: 'Sindh UET Test',
    full_name: 'Sindh Universities Engineering Entry Test',
    conducting_body: 'Sukkur IBA / MUET Joint',
    description: 'Combined entry test for engineering programs across Sindh public engineering universities.',
    applicable_for: ['Engineering', 'Computer Science', 'IT', 'Architecture'],
    registration_start: '2026-06-01',
    registration_deadline: '2026-07-31',
    test_date: '2026-08-15',
    result_date: '2026-09-01',
    website: 'https://iba-suk.edu.pk/admissions/',
    fee: 2000,
    eligibility: [
      'FSc Pre-Engineering with 60%+ marks',
      'DAE holders eligible for select programs',
      'Sindh domicile holders get preference',
    ],
    test_format: {
      total_marks: 100,
      total_questions: 100,
    ...
    tips: [
      'Standard FSc Pre-Engineering syllabus covers most topics',
      'Focus on mathematics problem solving',
      'Sindh domicile gives advantage in seat allocation',
      'Check for multiple test centers across Sindh',
    ],
    provinces: ['Sindh'],
    status_notes: 'Registration Expected June 2026',
  },
