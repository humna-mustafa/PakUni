                  ...
                  <ScrollView style={styles.optionsList} keyboardShouldPersistTaps="handled">
                    {editField.options?.map(option => (
                      <TouchableOpacity
                        ...
                        <Text style={[styles.optionText, {color: colors.text}, profile[editField.key as keyof UserProfile] === option && {color: colors.primary, fontWeight: TYPOGRAPHY.weight.semibold}]}>
                          {option}
                        </Text>
...
const styles = StyleSheet.create({
  ...
  profileName: { fontSize: TYPOGRAPHY.sizes.lg, fontWeight: TYPOGRAPHY.weight.bold, color: '#FFFFFF', marginBottom: 2, letterSpacing: -0.3, textShadowColor: 'rgba(0,0,0,0.2)', textShadowOffset: { width: 0, height: 1 }, textShadowRadius: 4 },
  profileClass: { fontSize: TYPOGRAPHY.sizes.xs, color: 'rgba(255,255,255,0.9)', fontWeight: TYPOGRAPHY.weight.medium, letterSpacing: 0.2 },
  tabsContainer: {
    flexDirection: 'row',
  ...
  sectionTitle: { fontSize: TYPOGRAPHY.sizes.md, fontWeight: TYPOGRAPHY.weight.bold, marginBottom: SPACING.sm },
  ...
  marksFixedText: { fontSize: TYPOGRAPHY.sizes.md, fontWeight: TYPOGRAPHY.weight.medium },
  ...
  actionBtnText: { color: '#FFFFFF', fontSize: TYPOGRAPHY.sizes.md, fontWeight: TYPOGRAPHY.weight.bold },
  ...
  secondaryBtnText: { fontSize: TYPOGRAPHY.sizes.md, fontWeight: TYPOGRAPHY.weight.semibold },
  ...
  savedTitle: { fontSize: TYPOGRAPHY.sizes.md, fontWeight: TYPOGRAPHY.weight.bold },
  savedCount: { paddingHorizontal: SPACING.md, paddingVertical: SPACING.xs, borderRadius: RADIUS.full },
  savedCountText: { fontSize: TYPOGRAPHY.sizes.sm, fontWeight: TYPOGRAPHY.weight.bold },
  ...
  savedInfo: { flex: 1 },
  savedName: { fontSize: TYPOGRAPHY.sizes.md, fontWeight: TYPOGRAPHY.weight.semibold },
  savedType: { fontSize: TYPOGRAPHY.sizes.xs, marginTop: 2 },
  removeBtn: { width: 44, height: 44, borderRadius: 22, justifyContent: 'center', alignItems: 'center' }, // WCAG 2.1 minimum touch target
  removeBtnText: { fontSize: 16, fontWeight: TYPOGRAPHY.weight.semibold },
  ...
  quickActionLabel: { flex: 1, fontSize: TYPOGRAPHY.sizes.md, fontWeight: TYPOGRAPHY.weight.medium },
  ...
  aboutTitle: { fontSize: TYPOGRAPHY.sizes.xl, fontWeight: TYPOGRAPHY.weight.heavy, marginBottom: 4 },
  ...
  logoutText: { color: '#FFFFFF', fontSize: TYPOGRAPHY.sizes.md, fontWeight: TYPOGRAPHY.weight.bold },
  quickActionCompact: { width: '47%', borderRadius: RADIUS.lg, padding: SPACING.md, alignItems: 'center' },
  quickActionIconSmall: { width: 44, height: 44, borderRadius: 22, justifyContent: 'center', alignItems: 'center', marginBottom: 6 }, // WCAG 2.1 minimum
  quickActionLabelSmall: { fontSize: TYPOGRAPHY.sizes.xs, fontWeight: TYPOGRAPHY.weight.semibold },
  ...
  modalTitle: { fontSize: TYPOGRAPHY.sizes.lg, fontWeight: TYPOGRAPHY.weight.bold },
  ...
  optionCheck: { fontSize: 18, fontWeight: TYPOGRAPHY.weight.bold },
  ...
  themeCheck: { fontSize: 20, fontWeight: TYPOGRAPHY.weight.bold },
});
